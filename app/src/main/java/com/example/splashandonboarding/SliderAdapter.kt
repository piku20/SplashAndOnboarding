...
import com.example.splashandonboarding.databinding.SlideItemBinding
...
class SliderAdapter(
    ...
    class SliderViewHolder( var binding: SlideItemBinding) : RecyclerView.ViewHolder(binding.root)
}